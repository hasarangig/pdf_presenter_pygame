...
# Note: An external docstring gets assigned to this module's `__doc__` attribute
# towards the end of this file; this provides the package with appropriate
# documentation during interactive sessions, e.g. via "help( packagename )".
